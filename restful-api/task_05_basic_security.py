...
def basic_auth_error():
    # Consistent 401 for auth errors
...
def login():
    ...
    if not username or not password:
        # Keep it simple; tests usually validate valid case
    ...
    # Embed identity in token (can include role info)
...
def admin_only():
    ...
    # identity may be dict (as we created) or string in some cases
